...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			else
			{
				...
				$this->session->set_flashdata('message', '<div class="alert alert-warning text-center" role="alert"> Email atau Password salah!</div>');
	...
	public function logout()
	{
		...
		// redirect them to the login page
		$this->session->set_flashdata('message', '<div class="alert alert-success text-center" role="alert">Berhasil LogOut!</div>');
		redirect('auth/login', 'refresh');
	}
